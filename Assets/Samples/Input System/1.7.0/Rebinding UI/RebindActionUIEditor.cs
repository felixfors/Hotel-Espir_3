...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_CancelActionInputProperty = serializedObject.FindProperty("cancelActionInput");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_CancelActionInputProperty);
        ...
        private SerializedProperty m_CancelActionInputProperty;
