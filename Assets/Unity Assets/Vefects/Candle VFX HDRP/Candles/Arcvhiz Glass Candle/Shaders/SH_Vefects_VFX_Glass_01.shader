	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNdotV16 = dot( normalWS, V );
				...
				surfaceDescription.BaseColor = _Color01.rgb;
				...
				surfaceDescription.Alpha = saturate( lerpResult20 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float fresnelNdotV16 = dot( ase_worldNormal, V );
				float fresnelNode16 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV16, _FresnelPower ) );
				float lerpResult20 = lerp( _OpacityMin , _OpacityMax , saturate( fresnelNode16 ));
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float fresnelNdotV16 = dot( packedInput.normalWS, V );
				float fresnelNode16 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV16, _FresnelPower ) );
				float lerpResult20 = lerp( _OpacityMin , _OpacityMax , saturate( fresnelNode16 ));
...
WireConnection;49;0;22;5
WireConnection;49;7;28;0
WireConnection;49;9;21;0
ASEEND*/
//CHKSM=619D2C7B1F7CCB2BB576397C3C7B0D751306004B