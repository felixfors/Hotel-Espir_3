	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord48 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult49 = smoothstep( _TipPosition , ( _TipPosition + _TipFalloff ) , texCoord48.y);
				float temp_output_50_0 = saturate( smoothstepResult49 );
				float3 lerpResult66 = lerp( _WickColor.rgb , _TipColor.rgb , temp_output_50_0);
				
				surfaceDescription.BaseColor = lerpResult66;
				...
				surfaceDescription.Emission = ( ( _TipColor.rgb * temp_output_50_0 ) * _EmissiveIntensity );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord48 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult49 = smoothstep( _TipPosition , ( _TipPosition + _TipFalloff ) , texCoord48.y);
				float temp_output_50_0 = saturate( smoothstepResult49 );
				float3 lerpResult66 = lerp( _WickColor.rgb , _TipColor.rgb , temp_output_50_0);
...
WireConnection;66;0;22;5
WireConnection;66;1;40;5
WireConnection;66;2;50;0
WireConnection;55;0;66;0
WireConnection;55;6;41;0
WireConnection;55;7;28;0
ASEEND*/
//CHKSM=D8FDC56D5340A27D40A5353E7A286027A2BC781F