	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord63 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult60 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord63 * _NormalUVS ) ).rgb , _NormalIntensity);
				
				float lerpResult53 = lerp( _SmoothnessVC , _Smoothness , packedInput.ase_color.r);
				
				surfaceDescription.BaseColor = _WaxColor.rgb;
				surfaceDescription.Normal = lerpResult60;
				...
				surfaceDescription.Smoothness = lerpResult53;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord63 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult60 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord63 * _NormalUVS ) ).rgb , _NormalIntensity);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord63 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult60 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord63 * _NormalUVS ) ).rgb , _NormalIntensity);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord63 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult60 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord63 * _NormalUVS ) ).rgb , _NormalIntensity);
...
WireConnection;68;0;26;5
WireConnection;68;1;60;0
WireConnection;68;7;53;0
WireConnection;68;61;66;5
ASEEND*/
//CHKSM=C7214D2D141E67D6751F436D69C8CF3A84D5F6AB