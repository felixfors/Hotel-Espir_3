	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord57 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult53 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord57 * _NormalUVS ) ).rgb , _NormalIntensity);
				
				surfaceDescription.BaseColor = _WaxColor.rgb;
				surfaceDescription.Normal = lerpResult53;
				...
				#ifdef _MATERIAL_FEATURE_TRANSMISSION
				surfaceDescription.TransmissionMask = _WaxSSSColor.rgb.x;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord57 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult53 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord57 * _NormalUVS ) ).rgb , _NormalIntensity);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord57 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 lerpResult53 = lerp( float3(0,0,1) , tex2D( _NormalTexture, ( texCoord57 * _NormalUVS ) ).rgb , _NormalIntensity);
...
WireConnection;62;0;26;5
WireConnection;62;1;53;0
WireConnection;62;7;52;0
WireConnection;62;61;60;5
ASEEND*/
//CHKSM=FD5D10FA379E708F7D510830A181ACAA19542B60